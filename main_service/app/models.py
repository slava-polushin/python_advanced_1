...
class Orders(Base):
    ...
    start_latitude = mapped_column(Numeric(7, 5), comment='широта точки старта')
    start_longitude = mapped_column(Numeric(8, 5), comment='долгота точки старта')
    finish_address = mapped_column(String, comment='Адрес завершения поездки')
    finish_latitude = mapped_column(Numeric(7, 5), comment='широта точки финиша')
    finish_longitude = mapped_column(Numeric(8, 5), comment='долгота точки финиша')
...
class CarStatus(Base):
    ...
    current_latitude = mapped_column(Numeric(7, 5), comment='Широта текущего местоположения')
    current_longitude = mapped_column(Numeric(8, 5), comment='Долгота текущего местоположения')
